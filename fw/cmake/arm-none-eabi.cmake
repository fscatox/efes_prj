...
if(NOT (TARGET ARM::BareMetal))
    add_library(ARM::BareMetal INTERFACE IMPORTED)
    target_link_libraries(ARM::BareMetal INTERFACE ARM)
    target_compile_options(ARM::BareMetal INTERFACE -ffreestanding)
    target_link_options(ARM::BareMetal INTERFACE -nostdlib)
endif()
